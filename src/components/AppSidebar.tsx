...
const navItems = [
  ...
  { title: '10. Melhoria Contínua', icon: TrendingUp, url: '/modulo/10' },
]
...
export function AppSidebar() {
  ...
  return (
    <Sidebar variant="sidebar" collapsible="icon">
      <SidebarHeader className="p-4 border-b border-sidebar-border">
        <div className="flex items-center gap-2 overflow-hidden px-2">
          ...
          <div className="flex flex-col truncate">
            <span className="font-bold text-lg leading-tight tracking-tight">SGC ISO</span>
      ...
      <SidebarContent>
        <SidebarGroup>
          <SidebarGroupLabel>Navegação ISO</SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
              {navItems.map((item) => (
