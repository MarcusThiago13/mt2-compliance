      ...
      <CardContent className="space-y-6">
        ...
        <div className="bg-muted/30 p-4 rounded-lg border">
          ...
          <p className="text-xs text-muted-foreground mt-3">
            O escopo do sistema de gestão foi determinado e é constantemente revisto considerando as
            questões externas e internas (4.1), os requisitos priorizados das partes interessadas
            (4.2), as obrigações formais (4.5) e a matriz atual de riscos da organização (4.6).
          </p>
        </div>
      </CardContent>
      {canEdit && (
